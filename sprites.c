...
void setup_background() {
    ...
    memcpy16_dma((unsigned short*) bg_palette, (unsigned short*) battletoads_pink_bg_palette, PALETTE_SIZE);

    /* load the image into char block 0 */
    memcpy16_dma((unsigned short*) char_block(0), (unsigned short*) battletoads_pink_bg_data,
    ...
    *bg1_control = 0 |    /* priority, 0 is highest, 3 is lowest */
    ...
    memcpy16_dma((unsigned short*) screen_block(16), (unsigned short*) level_wall, level_wall_width * level_wall_height);
    memcpy16_dma((unsigned short*) screen_block(24), (unsigned short*) level_road, level_road_width * level_road_height);
}
